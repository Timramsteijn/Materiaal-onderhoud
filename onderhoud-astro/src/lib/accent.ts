...
/** Zelfde variabelen als losse style-string, voor gebruik in .astro-bestanden. */
export function accentCss(onderdeel: AccentTokens): string {
  return Object.entries(accentStyle(onderdeel) as Record<string, string>)
